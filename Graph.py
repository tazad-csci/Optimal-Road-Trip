...
midwest_capitals = {'Des Moines': {'Springfield': [337, '<I-80>, <I-74>, <I-155>'], 'Indianapolis': [477, '<I-80>, <I-74>, <I-465>'], 'Lansing': [], 'St. Paul': [], 'Jefferson City': [], 'Bismarck': [], 'Lincoln': [], 'Columbus': [], 'Pierre': [], 'Madison': []},
                    ...
                    'Bismarck': {'Springfield': [], 'Indianapolis': [], 'Lansing': [], 'St. Paul': [], 'Jefferson City': [], 'Des Moines': [], 'Lincoln': [], 'Columbus': [], 'Pierre': [], 'Madison': []},
                    'Lincoln': {'Springfield': [], 'Indianapolis': [], 'Lansing': [], 'St. Paul': [], 'Jefferson City': [], 'Bismarck': [], 'Des Moines': [], 'Columbus': [], 'Pierre': [], 'Madison': []},
